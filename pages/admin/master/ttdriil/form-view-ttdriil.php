<?php	
	...
	$query	=mysql_query("SELECT * FROM tb_ttdriil WHERE id_ttdriil='1'");
...
<ol class="breadcrumb pull-right">
	...
	<li><a href="index.php?page=form-setup-ttdriil&id_ttdriil=<?=$data['id_ttdriil']?>" title="setup" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-gear"></i> &nbsp;Setup</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
