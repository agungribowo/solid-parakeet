<?php	
	...
	$query	=mysql_query("SELECT * FROM tb_ttdnominatif WHERE id_ttdnominatif='1'");
...
<ol class="breadcrumb pull-right">
	...
	<li><a href="index.php?page=form-setup-ttdnominatif&id_ttdnominatif=<?=$data['id_ttdnominatif']?>" title="setup" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-gear"></i> &nbsp;Setup</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
