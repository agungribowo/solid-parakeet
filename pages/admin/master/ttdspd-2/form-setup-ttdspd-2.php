<?php
	...
	$query   =mysql_query("SELECT * FROM tb_ttdspd2 WHERE id_ttdspd2='$id_ttdspd2'");
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Setup <small>Penandatangan Lembar SPD 2&nbsp;</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form Setup Penandatangan Lembar SPD 2</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=setup-ttdspd-2&id_ttdspd2=<?=$id_ttdspd2?>" class="form-horizontal" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<a type="button" class="btn btn-default active" href="index.php?page=form-view-ttdspd-2"><i class="ion-arrow-return-left"></i>&nbsp;Cancel</a>
						</div>
					</div>
				</form>
			</div>
