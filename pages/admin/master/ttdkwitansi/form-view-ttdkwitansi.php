<?php	
	...
	$query	=mysql_query("SELECT * FROM tb_ttdkwitansi WHERE id_ttdkwitansi='1'");
...
<ol class="breadcrumb pull-right">
	...
	<li><a href="index.php?page=form-setup-ttdkwitansi&id_ttdkwitansi=<?=$data['id_ttdkwitansi']?>" title="setup" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-gear"></i> &nbsp;Setup</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
