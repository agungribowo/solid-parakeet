...
$html ='<table border="0" cellspacing="0" cellpadding="4">
			...
			<tr>
				...
				<td width="210" style="border-top-width: solid;">Uang Harian 100% di '.$tuj['tujuan'].'</td>
				<td width="30" align="right" style="border-top-width: solid;">'.$data['jml_harian'].'</td>
				<td width="20" style="border-top-width: solid;">X</td>
				<td width="80" align="right" style="border-top-width: solid;border-right-width: solid;">'.number_format($data['nilai_harian'],0,",",".").'</td>
				<td align="right" style="border-top-width: solid;border-right-width: solid;">'.number_format($data['jml_harian']*$data['nilai_harian'],0,",",".").'</td>
				<td style="border-top-width: solid;border-right-width: solid;">'.$data['ket_harian'].'</td>
			</tr>
			<tr>
				...
				<td align="right" style="border-right-width: solid;">'.number_format($data['jml_harian1']*$data['nilai_harian1'],0,",",".").'</td>
				<td style="border-right-width: solid;">'.$data['ket_harian1'].'</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>X</td>
				<td align="right" style="border-right-width: solid;">'.number_format($data['nilai_reprentasi'],0,",",".").'</td>
				<td align="right" style="border-right-width: solid;">'.number_format($data['jml_reprentasi']*$data['nilai_reprentasi'],0,",",".").'</td>
