<?php
	...
	$expSpd	=mysql_query("SELECT * FROM tb_spd where id_satker=$satker ORDER BY id_spd ");
...
<?php
	include "../../config/koneksi.php";
	$satker = $_SESSION['id_satker'];
	$query	=mysql_query("SELECT * FROM tb_spd where id_satker=$satker ORDER BY id_spd DESC ");
?>
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
