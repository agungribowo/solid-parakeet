...
<ol class="breadcrumb pull-right">
	...
	<?php
		if ($tuj['jenis'] =="Luar Negeri"){
			echo'<li><a href="../../pages/admin/spd/cetak-spd-ln.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak SPD</a></li>';
			echo'<li><a href="../../pages/admin/spd/cetak-nom-ln.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-warning m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak Nominatif</a></li>';
		}
		else{
			if ($tuj['jenis'] =="Dalam Negeri"){
				echo'<li><a href="../../pages/admin/spd/cetak-spd.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak SPD</a></li>';
				echo'<li><a href="../../pages/admin/spd/cetak-nom-luar.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-warning m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak Nominatif</a></li>';
			}
			else{
				echo'<li><a href="../../pages/admin/spd/cetak-spd.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak SPD</a></li>';
				echo'<li><a href="../../pages/admin/spd/cetak-nom-dalam.php?id_spd=';echo $id_spd;echo'" target="_blank" title="cetak" class="btn btn-sm btn-warning m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak Nominatif</a></li>';
			}
		}
	?>
</ol>
