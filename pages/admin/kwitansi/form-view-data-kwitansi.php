					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a type="button" class="btn btn-primary btn-icon btn-sm" href="../../pages/admin/kwitansi/cetak-kwitansi.php?id_kwitansi=<?=$kwi['id_kwitansi']?>" target="_blank" title="cetak"><i class="fa fa-print fa-lg"></i></a>
							</td>
						</tr>
						<?php
							}
