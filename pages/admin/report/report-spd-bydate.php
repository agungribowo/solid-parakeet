<?php
	...
	$qry = "SELECT A.id_nominatif, A.pegawai, A.id_satker, B.nomor, B.tgl, B.keperluan, B.asal, B.tujuan, B.tgl_berangkat, B.tgl_kembali, B.no_sprin FROM tb_nominatif A INNER JOIN tb_spd B ON B.id_spd=A.id_spd WHERE A.id_satker=$satker AND B.tgl BETWEEN '$start' AND '$end'  ORDER BY A.pegawai,B.tgl DESC";
