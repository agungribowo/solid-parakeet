...
<ol class="breadcrumb pull-right">
	...
	<li><a href="../../pages/superadmin/rincian/cetak-rincian-ln.php?id_rincian=<?=$id_rincian?>" target="_blank" title="cetak" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
