...
<ol class="breadcrumb pull-right">
	...
	<li><a href="../../pages/superadmin/rincian/cetak-rincian.php?id_rincian=<?=$id_rincian?>" target="_blank" title="cetak" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print"></i> &nbsp;Cetak</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
								...
								<div class="table-responsive">
									...
									<table class="table">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td>Biaya penginapan di <?=$tuj['tujuan']?></td>
												<td><?=$data['jml_inap']?></td>
												<td>x</td>
												<td align="right"><?=number_format($data['nilai_inap'],0,",",".");?></td>
												<td align="right"><?=number_format($data['jml_inap']*$data['nilai_inap'],0,",",".");?></td>
												<td><?=$data['ket_inap']?></td>
											</tr>
											<tr>
												<td>2</td>
											...
											<tr>
												...
												<td>x</td>
												<td align="right"><?=number_format($data['nilai_kembali'],0,",",".");?></td>
												<td align="right"><?=number_format($data['jml_kembali']*$data['nilai_kembali'],0,",",".");?></td>
												<td><?=$data['ket_kembali']?></td>
											</tr>
											<tr>
												<td></td>
												<td>Taxi <?=$spd['asal']?> PP</td>
												<td><?=$data['jml_taxi_berangkat']?></td>
												<td>x</td>
												<td align="right"><?=number_format($data['nilai_taxi_berangkat'],0,",",".");?></td>
												<td align="right"><?=number_format($data['jml_taxi_berangkat']*$data['nilai_taxi_berangkat'],0,",",".");?></td>
												<td><?=$data['ket_taxi_berangkat']?></td>
											</tr>
											<tr>
												<td></td>
												<td>Taxi <?=$tuj['tujuan']?> PP</td>
												<td><?=$data['jml_taxi_kembali']?></td>
												<td>x</td>
												<td align="right"><?=number_format($data['nilai_taxi_kembali'],0,",",".");?></td>
												<td align="right"><?=number_format($data['jml_taxi_kembali']*$data['nilai_taxi_kembali'],0,",",".");?></td>
												<td><?=$data['ket_taxi_kembali']?></td>
											</tr>
											<tr>
												<td>3</td>
												<td>Uang Harian</td>
