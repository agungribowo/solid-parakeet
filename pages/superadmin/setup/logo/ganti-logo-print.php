...
<?php
	...
	if ($_POST['edit'] == "edit") {
		...
		$datename	=date('Ymd');
		$timename	=date('His');
		$new_name	="$datename"."-"."$timename"."-"."PRINT".".$ext";
	
		if (empty($_FILES['logo']['name'])) {
			$_SESSION['pesan'] = "Oops! Please fill all column ...";
			header("location:index.php?page=form-ganti-logo-print&id_logo=$id_logo");
		}
		...
		$update= mysql_query ("UPDATE tb_logo SET logo2='$new_name' WHERE id_logo='$id_logo'");
		if($update){
				$_SESSION['pesan'] = "Good! ganti logo print success ...";
