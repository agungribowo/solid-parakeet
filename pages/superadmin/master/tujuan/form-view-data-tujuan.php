...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Master <small>Tujuan&nbsp;</small></h1>
<!-- end page-header -->
<?php
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Results <span class="text-info"><?php echo mysql_num_rows($query);?></span> rows for "Data Tujuan"</h4>
			</div>
