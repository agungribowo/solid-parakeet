<?php
	...
	$query   =mysql_query("SELECT * FROM tb_ttdspd WHERE id_ttdspd='$id_ttdspd'");
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form Setup Penandatangan Lembar SPD 1</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=setup-ttdspd&id_ttdspd=<?=$id_ttdspd?>" class="form-horizontal" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<a type="button" class="btn btn-default active" href="index.php?page=form-view-ttdspd"><i class="ion-arrow-return-left"></i>&nbsp;Cancel</a>
						</div>
					</div>
				</form>
			</div>
