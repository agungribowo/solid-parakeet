...
<button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus">Tambah</i></button><br>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Uang Representasi</h6>
            </div>
            <div class="card-body">
  ...
  <thead>
    <tr>
                      <th class="th-sm" >Uraian</th>
                      <th class="th-sm" >Dalam Kota</th>
                       <th class="th-sm" >Luar Kota</th>
...
?>
                       <td><?=$data['uraian']?></td>
                      <td>Rp. <?=number_format($data['dlm_kota'])?></td>
                      <td>Rp. <?=number_format($data['luar_kota'])?></td>
            <td>
                    <!-- Button untuk modal -->
