...
<button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus">Tambah</i></button><br>
  ...
  <thead>
     <tr>
                      <th class="th-sm">NIP/NRP/NIK</th>
                      <th class="th-sm">Nama</th>
                      <th class="th-sm">Pangkat</th>
                      <th class="th-sm">Gol</th>
                       <th class="th-sm">Eselon</th>
                      <th class="th-sm">Unit Kerja</th>
...
?>
    <tr>
            ...
            <td>
                    <!-- Button untuk modal -->
<a href="#" type="button" class=" fa fa-edit btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $data['id_peg']; ?>"></a>
</td>
</tr>
 ...
 <!-- Modal -->
  <div id="myModalTambah" class="modal fade" role="dialog">
    ...
    <form action="../aksi/unit.php" method="get">
        <div class="modal-body">
Jenis ID : 
         <select  class="form-control " style="width: 100%;"   name="satker" required="required">
 ...
 -->
    ...
    <select  class="form-control " style="width: 100%;"   name="bendahara" required="required">
      ...
      <?php
        ...
        $q = mysqli_query($koneksi, "SELECT * FROM golongan");
        while($data1 = mysqli_fetch_array($q)){
          echo '<option value="'.$data1['nama_golongan'].'">'.$data1['nama_golongan'].' </option>';
        }
